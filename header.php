		...
		<header id="masthead" class="site-header" role="banner">
			<div class="site-header-main">
				<div class="site-branding">
					<?php classicsixteen_the_custom_logo(); ?>
			...
			<?php if ( get_header_image() ) : ?>
				<?php
					/**
					 * Filter the default classicsixteen custom header sizes attribute.
					 *
					 ...
					 */
					$custom_header_sizes = apply_filters( 'classicsixteen_custom_header_sizes', '(max-width: 709px) 85vw, (max-width: 909px) 81vw, (max-width: 1362px) 88vw, 1200px' );
				?>
